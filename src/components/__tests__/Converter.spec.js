...
describe('Converter.vue', () => {
    ...
    describe('calculates computed values correctly', () => {
        const inputArray = [{ value: "USD", text: "USD" }, { value: "GBP", text: "GBP" }, { value: "EUR", text: "EUR" }, { value: "EUR2", text: "EUR2" }]
        ...
        it(`computed value outputArray should be filtered when filter is enabled }.`, () => {
            wrapper.setProps({filterOutputCurrencies:true});
    ...
    describe('component should calculate correct output amount.', () => {
        ...
        it(`1 USD should be equal to 14.84944 TRY.`, () => {
            wrapper.setData({ selectedInput: "USD", selectedOutput: "TRY", amount: "1" })
            expect(wrapper.vm.calculatedAmount).to.eql(14.84944);
        });

        it(`1 USD should be equal to 0.000025309582 BTC.`, () => {
            wrapper.setData({ selectedInput: "USD", selectedOutput: "BTC", amount: "1" })
        ...
        it(`1.2 USD should be equal to 17.819328 TRY`, () => {
            wrapper.setData({ selectedInput: "USD", selectedOutput: "TRY", amount: "1.2" })
        ...
        it(`1.205 input should be parsed to 1.20`, () => {
            ...
            expect(wrapper.find("b-form-input").attributes().modelvalue).to.equal("1.20");
        });
